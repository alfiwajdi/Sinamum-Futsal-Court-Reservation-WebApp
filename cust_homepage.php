<?php
  ...
  try{
    // Prepare statement
    $stmt = mysqli_prepare($mysqli, "SELECT id, name, phone, start, end, resource_id, total_payment, deposit_payment, make_payment FROM events WHERE cust_id = ?");
...
<body>
  ...
  <table id="system">
        <tr style="height: 38px;">
            <td><a href="cust_homepage.php" class="navbar-brand" style="color: #FFFFFF" >&nbsp;&nbsp;Home Page</a></td>
            <td>
                <a href="logout.php"><img src="img/off_icon.png" style="width: 20px; height: 20px; float: right; margin-right: 15px;"></a>
            </td>
        </tr>
  </table>
    <br>
    ...
    <div class="slideshow-container">
      ...
      <div class="mySlides fade">
        ...
        <img src="https://d3avoj45mekucs.cloudfront.net/rojakdaily/media/jessica-chua/news/2017/oct/futsal%20court%20in%20every%20housing%20estate/pahang-futsal.jpg" style="width:100%" height="500px">
      </div>

      <div class="mySlides fade">
        <div class="numbertext">2 / 3</div>
        <img src="https://d3avoj45mekucs.cloudfront.net/rojakdaily/media/jessica-chua/news/2017/oct/futsal%20court%20in%20every%20housing%20estate/futsal-court.png?ext=.png" style="width:100%" height="500px">
      </div>

      <div class="mySlides fade">
        <div class="numbertext">3 / 3</div>
        <img src="https://www.inspiresport.com/wp-content/uploads/2019/05/Children-playing-futsal-indoors.jpg" style="width:100%" height="500px">
      </div>
    </div>
  <br>
        ...
        if(mysqli_stmt_affected_rows($stmt) == 0 || mysqli_stmt_affected_rows($stmt) < 0){
            ...
            while ($row = mysqli_fetch_array($result, MYSQLI_NUM))
            {
              ...
              $make_payment = $row[8];
                ...
                if($make_payment == 0){
                echo "<td>";
                echo "<a href='cust_update_event.php?id=$book_id' style='text-decoration:none;'><button class='btn btn-sm btn-warning'>Edit</button></a> &nbsp;";
                echo "<a href='back_cust_payment.php?id=$book_id' style='text-decoration:none;'><button class='btn btn-sm btn-secondary'>Pay</button></a>";
                echo "</td>";
                }
                else{
                  echo "<td>";
  ...
  <script type="text/javascript">
      ...
      // function changeDate() {
      //   dp.startDate = document.getElementById('date').value;
